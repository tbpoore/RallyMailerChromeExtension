...
$(function () {
    ...
    var activateActionButton = function (actionButton) {
        ...
        _action
            ...
            options: {
                ...
                display: 'block',
                complete: function() {
                    _action.tooltip({ delay: 50 });
                }
            }
        });
    };

    var activateEmailAction = function() {
        $('#copyToClipboard')
            .velocity({
                properties: {
                    scale: 0,
    ...
    chrome.runtime.onMessage.addListener(function (request, sender, sendResponse) {
        ...
        if (request.action === 'showSelectedArtifacts') {
            ...
            request.artifacts.forEach(function (artifact) {
